  ...
  return (
    <div>
      ...
      {!session ? (
        ...
        <main className='relative min-h-screen after:bg-home after:bg-center after:bg-no-repeat after:bg-cover after:bg-fixed after:absolute after:inset-0 after:z-[-1]'>
          <Slider />
          <Brands />
